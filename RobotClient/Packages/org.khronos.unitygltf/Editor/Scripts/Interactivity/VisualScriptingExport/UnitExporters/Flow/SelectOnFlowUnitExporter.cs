...
namespace UnityGLTF.Interactivity.VisualScripting.Export
{
    public class SelectOnFlowUnitExporter : IUnitExporter
    {
        ...
        public bool InitializeInteractivityNodes(UnitExporter unitExporter)
        {
            ...
            var varIndex = unitExporter.vsExportContext.AddVariableWithIdIfNeeded($"SelectOnFlowValue_{UnityEngine.GUID.Generate().ToString()}", null, VariableKind.Scene, typeIndex);
